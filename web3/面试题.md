...
-   **抽象类**：不能被实例化，只能作为其他类的基类。它可以有实现的方法，也可以有抽象方法，子类必须实现这些抽象方法。
...
-   `getInstance` 方法保证了无论调用多少次，都只会创建一个实例。
...
-   `number[]` 和 `Array<number>` 都可以用来定义数字数组。
...
2.  **拆分项目**：将项目拆分为多个模块，使用 `project references` 来提高构建效率。
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTc5OTcyMDE5OCw0Njk3MDU0NzEsLTc0MD
IzMDU2LC0xOTEwMjA0NTY4LC02OTIyOTU0MzUsLTc1NTQ0NDk0
OCwtMzc4ODg5OTgzLDE1MjU3MjIzMzcsMTA0NTA5MjExOSwtMT
E2ODA1NjYyOCwtNTM5MDA0NTg3LDcxNjI4ODk0Myw3MjM0NzU5
NSwtMTM0NDg1MDQ3NywtMTc5NDY2OTI1NSwxOTU4MzA1MDYyLC
0xMDY1NTc3Mjk2LC0xOTA0ODgwMzkxLC00MzkxMjgzNTAsNzcz
OTAyMjMwXX0=
-->