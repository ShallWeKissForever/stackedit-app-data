...
在渲染完成并且 React 更新 DOM 之后，浏览器就会重新绘制屏幕。尽管这个过程被称为“浏览器渲染”（“browser rendering”），但我们还是将它称为“绘制”（“painting”），以避免在**加粗文本**这些文档的其余部分中出现混淆。
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTI5ODQxODM5MywtOTk5MDU2NjYxLC0xND
